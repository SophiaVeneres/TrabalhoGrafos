...
void GrafoTeste(int qnt_vertices, int**sistema_rodoviario){
    ...
    sistema_rodoviario[0][1] = 12*4;
    sistema_rodoviario[0][2] = 8*4;
    sistema_rodoviario[1][0] = 12*4;
    sistema_rodoviario[2][0] = 8*4;
    sistema_rodoviario[1][3] = 1*4;
    sistema_rodoviario[2][3] = 8*4;
    sistema_rodoviario[3][2] = 8*4;
    sistema_rodoviario[3][1] = 1*4;
